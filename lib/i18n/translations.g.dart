...
class _TranslationsJa implements _TranslationsEn {
	...
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	_TranslationsJa.build({PluralResolver? cardinalResolver, PluralResolver? ordinalResolver})
		: _cardinalResolver = cardinalResolver,
		  _ordinalResolver = ordinalResolver;
	...
	@override String get sort_recommendation => 'おすすめ順';
	@override String get sort_star => 'スター';
	@override String get sort_fork => 'フォーク';
	@override String get sort_updated => '更新日';
